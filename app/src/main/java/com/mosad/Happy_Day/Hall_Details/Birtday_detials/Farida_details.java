...
public class Farida_details extends AppCompatActivity {
    RatingBar ratingBar;
    Button btn_book;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_farida_details);
        ...
        ratingBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float v, boolean b) {
                ...
                Toast.makeText(Farida_details.this, "Value is " +v, Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void book(View view) {
        ...
        Intent intent =new Intent(Farida_details.this, BookingActivity.class);
