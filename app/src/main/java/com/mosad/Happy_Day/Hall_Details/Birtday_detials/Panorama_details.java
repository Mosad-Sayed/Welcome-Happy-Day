...
public class Panorama_details extends AppCompatActivity {
    RatingBar ratingBar;
    Button btn_book;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_panorama_details);
        ...
        ratingBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float v, boolean b) {
                ...
                Toast.makeText(Panorama_details.this, "Value is " +v, Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void book(View view) {
        ...
        Intent intent =new Intent(Panorama_details.this, BookingActivity.class);
