...
public class Riviera_detials extends AppCompatActivity {
    RatingBar ratingBar;
    Button btn_book;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_riviera_detials);
        ...
        ratingBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float v, boolean b) {
                ...
                Toast.makeText(Riviera_detials.this, "Value is " +v, Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void book(View view) {
        ...
        Intent intent =new Intent(Riviera_detials.this, BookingActivity.class);
