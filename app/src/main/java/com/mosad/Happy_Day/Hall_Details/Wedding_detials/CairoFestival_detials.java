...
public class CairoFestival_detials extends AppCompatActivity {
    RatingBar ratingBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cairo_festival_detials);
        ...
        ratingBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float v, boolean b) {
                ...
                Toast.makeText(CairoFestival_detials.this, "Value is " + v, Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void btn_cairo(View view) {
        ...
        final TextView Output = (TextView) findViewById(R.id.txt_cairo);
        String Data = Output.getText().toString();
        Intent intent =new Intent(CairoFestival_detials.this, BookingActivity.class);
