...
public class Festival_detials extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_festival_detials);
        ...
        ratingBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float v, boolean b) {
                ...
                Toast.makeText(Festival_detials.this, "Value is " + v, Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void btn_fstvial(View view) {
        final TextView Output = (TextView) findViewById(R.id.txt_festval);
        String Data = Output.getText().toString();
        Intent intent =new Intent(Festival_detials.this, BookingActivity.class);
